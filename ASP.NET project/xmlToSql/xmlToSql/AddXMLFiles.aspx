...
<body>
    ...
    <div>
        <asp:HyperLink ID="HyperLinkBackFromXMLFiles" runat="server" ForeColor="#009933" NavigateUrl="~/Default.aspx">Върни се обратно на началната страница</asp:HyperLink>
        <br />
        <br />
        <br />
        <asp:Label ID="Label9" runat="server" Font-Size="Large" ForeColor="#009933" Text="Обработка на XML файловете, които се намират в директорията 'resources' на проекта!"></asp:Label>
        <br />
        <br />
    ...
    <add name=“ASP.NET v4.0“ autoStart=“true“ managedRuntimeVersion=“v4.0“ managedPipelineMode=“Integrated“>
        ...
        <br />
        <br />
        <asp:Label ID="Label8" runat="server" Text="Статус на валидацията"></asp:Label>
        <br />
        <asp:TextBox ID="TextBoxValidationStatus" runat="server" Height="135px" MaxLength="65000" Rows="1000" TextMode="MultiLine" Width="654px"></asp:TextBox>
        <br />
        <br />
        <br />
        <br />
